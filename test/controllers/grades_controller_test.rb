...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference("Grade.count") do
      post grades_url, params: { grade: { grade1: @grade.grade1, grade2: @grade.grade2, grade3: @grade.grade3 } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { grade1: @grade.grade1, grade2: @grade.grade2, grade3: @grade.grade3 } }
